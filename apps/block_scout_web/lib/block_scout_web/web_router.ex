defmodule BlockScoutWeb.WebRouter do
  ...
  scope "/", BlockScoutWeb do
    ...
    resources("/transaction_history_chart", Chain.TransactionHistoryChartControllerHome, only: [:show], singleton: true)

    resources("/address_total_history_chart", Chain.AddressTotalHistoryChartController, only: [:show], singleton: true)
