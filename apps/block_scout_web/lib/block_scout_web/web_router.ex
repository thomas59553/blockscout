defmodule BlockScoutWeb.WebRouter do
  ...
  scope "/", BlockScoutWeb do
    ...
    resources("/address_total_history_chart", Chain.AddressTotalHistoryChartController,
    only: [:show],
    singleton: true
    )
    resources("/transfer_history_chart", Chain.TransferHistoryChartHomeController,
    only: [:show],
    singleton: true
    )
